...
public static class ICMAgent
{
    ...
    "<strong>Whenever you are communicating ICM incidents, create a hyperlink for incident id using the format : https://portal.microsofticm.com/imp/v5/incidents/details/{incident_id}/summary </strong>\n\n" +
     ...
     "2. **Invoke the appropriate function to fetch the ICM incident details and understand the ask from the incident.**\n\n" +
     ...
     "4. **If the Incident is reporting a customer issue:**\n" +
     ...
     "5. **If the user asks to mitigate the incident:** Generate an HTML summary of the incident and your findings and use it as discussion entry to mitigate the incident and communicate the outcome to the user.\n\n" +
     "6. **If the user asks for an RCA (root-cause analysis) for an incident:**\n" +
     ...
     "7. **If the user asks for a Five Why's analysis of an Outage incident here are the five questions that you should focus on drafting and answering:**\n" +

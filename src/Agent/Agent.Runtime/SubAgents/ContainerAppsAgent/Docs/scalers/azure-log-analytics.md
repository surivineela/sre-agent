...
type: Opaque
data:
  tenantId: "" #Base64 encoded Azure Active Directory tenant id
  clientId: "" #Base64 encoded Application id from your Azure AD Application/service principal
  clientSecret: "=" #Base64 encoded Password from your Azure AD Application/service principal
  workspaceId: "=" #Base64 encoded Log Analytics workspace id
---

...
type: Opaque
data:
  apiKey: # base64 encoding of the new relic api key
  account: # base64 encoding of the new relic account number 123456
  region: # base64 encoding of the new relic region US
---

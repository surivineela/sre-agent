...
/// <summary>
/// Validator for Azure Monitor incident indexing configuration.
/// Currently returns "not yet supported" - stub implementation.
/// </summary>
public class AzMonitorIncidentIndexingConfigurationValidator : IIncidentIndexingConfigurationValidator
{
    ...
    public Task<IncidentIndexingValidationResult> ValidateAsync<TPayload>(TPayload request)
    {
        return Task.FromResult(new IncidentIndexingValidationResult(
            ...
            Details: "Azure Monitor incident indexing configuration is not yet implemented. Please use ICM for now."));
    }
}

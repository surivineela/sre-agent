...
[TestClass]
public class AKSAgentReasoningEvals
{
    ...
    {
        var dataFolderPath = Path.Combine(AppContext.BaseDirectory, "Data", "AKSAgent");
    ...
    public async Task AKSAgentReasoningTests(ModelGenerationContent testData)
    {

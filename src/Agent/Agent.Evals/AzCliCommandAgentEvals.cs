...
[TestClass]
public class AzCliCommandAgentEvals
{
    ...
    public async Task AzCliCommandTests(string fileName, ModelGenerationContent testData)
    {
        ...
        var actualStructuredOutput = actualText?.Text is not null
            ...
            : null;
        // structured output is not stable
        //Assert.IsFalse((actualText == null && expectedText != null) || (actualText != null && expectedText == null));
        ...
        Assert.IsFalse((actualFnCall == null && expectedFunctionCall != null) || (actualFnCall != null && expectedFunctionCall == null));

...
export const useAgentTaskStreamHandler = () => {
    ...
    const updateTreeState = useCallback(
        (task: AgentTask | null, currentTreeState: InvestigationTreeState | null) => {
                ...
                if (properties) {
                    ...
                    if (initialInvestigation) {
                        ...
                        const initialInvestigationNode: InvestigationTreeNode = {
                            id: id,
                            title: intl.formatMessage(SreAgentResources.incidentResearch),
                            description:
                                initialInvestigation.summary ||
                                initialInvestigation.statusMessage ||
                                intl.formatMessage(SreAgentResources.incidentResearchInProgress),
                            status: equals(
                                initialInvestigation.status,
                                InvestigationStatusCommon.Complete,
                            ...
                            incidentDescription: initialInvestigation.incidentDescription,
                            timeFrame: initialInvestigation.timeFrame,
                            affectedResources: initialInvestigation.affectedResources,
                            keyFindings: initialInvestigation.keyFindings,
                            details: initialInvestigation.details,
                            toolNames: initialInvestigation.toolNames || null,
                        };

...
const KnowledgeGraph = ({ transferDataToActivities }: { transferDataToActivities: (threadId?: string | null) => void }) => {
    ...
    return isLoading ?
        ...
        <Graph nodes={nodes} links={links} addNodes={addNodes} hideNode={hideNode} showNode={showNode} queryNodes={queryNodes} transferDataToActivities={transferDataToActivities} />;
};

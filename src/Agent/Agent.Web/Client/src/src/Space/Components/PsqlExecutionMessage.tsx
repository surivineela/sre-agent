...
// PostgreSQL Execution Component
const PsqlExecutionMessage: FC<{
    ...
    const [isExecutionCollapsed, setIsExecutionCollapsed] = useState(
    ...
    const getRiskColor = (riskLevel: string) => {
        ...
        return '#6b7280'; // safe/unknown
    };

    const riskLevel = getRiskLevel(currentExecution.command, intl);
    ...
    return (
        ...
        >
            ...
            {/* Action buttons for pending states - FIXED TO MATCH AZURE CLI EXACTLY */}
            {(currentExecution.status === 'Pending' || currentExecution.status === 'PendingAuthorization') && (
            ...
            {/* Credential messages for pending states */}
            {currentExecution.status === 'Pending' && (
                <p
                    style={{
                        fontSize: '11px',
...
export default PsqlExecutionMessage;

                                ...
                                <DialogContent className={styles.dialogContent}>
                                    ...
                                    <div
                                        className={mergeClasses(
                                            styles.dropZone,
                                            isDragOver ? styles.dropZoneDragOver : styles.dropZoneIdle
                                        )}
                                    ...
                                    <div className={styles.uploadInfoContainer}>
                                        ...
                                        <Text className={styles.uploadInfoText}>
                                            {intl.formatMessage(KnowledgeBaseResources.maximumFileSize)}
                                        </Text>
                                    </div>
                    ...
                    <DeleteConfirmationDialog
                        ...
                        message={
                            fileToDelete
                                ...
                                : selectedUploadedFileKeys.length > 1
                                  ? intl.formatMessage(KnowledgeBaseResources.deleteFilesMessage, {
                                        count: selectedUploadedFileKeys.length,
                                    })
                                  : intl.formatMessage(KnowledgeBaseResources.deleteFileMessage)
                        }

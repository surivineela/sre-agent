...
import { ExtendedAgentsGraphResources, KnowledgeBaseResources, SettingsTabResources } from '../../Strings/SREAgentResources';
...
const DataKnowledgeSpace: FC = () => {
    ...
    const [selectedTab, setSelectedTab] = useState<TabValues>(TabValues.Documents);
        ...
        <div className={styles.settingsContainer}>
            ...
            <div className={styles.tabsContainer}>
                <TabList selectedValue={selectedTab} onTabSelect={onTabSelect} style={getTabListStyle(theme as Theme)}>
                    <Tab id="Documents" value={TabValues.Documents}>
                        {intl.formatMessage(ExtendedAgentsGraphResources.filesTab)}
                    </Tab>
            ...
            <div className={styles.containerDivider}>
                {selectedTab === TabValues.Documents && <KnowledgeBase />}

...
import { Button, Dialog, DialogActions, DialogBody, DialogSurface, DialogTitle, InputOnChangeData, SearchBox, SearchBoxChangeEvent } from '@fluentui/react-components';
    ...
    return (
            <div className={styles.container}>
                ...
                <Dialog open={showDeleteConfirmationDialog} onOpenChange={(_, data) => setShowDeleteConfirmationDialog(data.open)}> 
                    <DialogSurface>
                            <DialogTitle>
                                {intl.formatMessage(ManagedResourcesStringResources.deleteTitle)}
                            </DialogTitle>
                        <DialogBody style={{display: "flex"}}>
                            {intl.formatMessage(ManagedResourcesStringResources.confirmDelete)}
                        </DialogBody>
                        <DialogActions>
                            <Button appearance="transparent" className={styles.dangerButton} onClick={() => {

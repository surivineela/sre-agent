...
export const IncidentManagementNotificationResources = defineMessages({
    ...
    deleteFilterError: { defaultMessage: 'Failed to delete incident handler', id: 'jET8aI' },
    createFilterTitle: { defaultMessage: 'Creating incident handler', id: 'foUmLR' },
    createFilterInProgress: { defaultMessage: 'Creating incident handler', id: 'foUmLR' },
    createFilterSuccess: { defaultMessage: 'Successfully created incident handler', id: 'UqCC2s' },
    createFilterError: { defaultMessage: 'Failed to create incident handler', id: 'WnIWxR' },
    updateFilterTitle: { defaultMessage: 'Updating incident handler', id: 'XdHOL0' },
    updateFilterInProgress: { defaultMessage: 'Updating incident handler', id: 'XdHOL0' },
    updateFilterSuccess: { defaultMessage: 'Successfully updated incident handler', id: 'PEHogk' },
    updateFilterError: { defaultMessage: 'Failed to update incident handler', id: 'NMJ8PI' },
    enableFilterTitle: { defaultMessage: 'Enabling incident handler', id: 'vTlFW1' },
    enableFilterInProgress: { defaultMessage: 'Enabling incident handler', id: 'vTlFW1' },
    enableFilterSuccess: { defaultMessage: 'Successfully enabled incident handler', id: 'GgiTLF' },
    enableFilterError: { defaultMessage: 'Failed to enable incident handler', id: 'OYG48f' },
    disableFilterTitle: { defaultMessage: 'Disabling incident handler', id: '066KEg' },
    disableFilterInProgress: { defaultMessage: 'Disabling incident handler', id: '066KEg' },
    disableFilterSuccess: { defaultMessage: 'Successfully disabled incident handler', id: 'EiiZbj' },
    disableFilterError: { defaultMessage: 'Failed to disable incident handler', id: 'h6EziO' },
});
...
export const DataConnectionsResources = defineMessages({
    ...
    createDataConnection: { defaultMessage: 'Create data connection', id: 'Rs21a/' },
    editDataConnection: { defaultMessage: 'Edit data connection', id: 'q0L4ui' },
    ...
    typePlaceholder: { defaultMessage: 'Select connection type', id: 'Hdb3ai' },
    ...
    deletingDataConnection: { defaultMessage: 'Deleting data connection', id: 'Aspdkq' },
    ...
    creatingDataConnection: { defaultMessage: 'Creating data connection', id: '8WhIoh' },
    ...
    updatingDataConnection: { defaultMessage: 'Updating data connection', id: 'ZuNJYO' },

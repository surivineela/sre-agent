...
export const ScheduledTasksResources = defineMessages({
    ...
    tasksDeletedSuccessfully: {
        defaultMessage: 'Scheduled task(s) deleted successfully',
        id: 'z7SGAU',
    },
    taskPausedSuccessfully: {
        defaultMessage: 'Scheduled task turned off successfully',
        id: '2YgmBr',
    },
    tasksPausedSuccessfully: {
        defaultMessage: 'Scheduled task(s) turned off successfully',
        id: 'Mx6yYf',
    },
    taskResumedSuccessfully: {
        defaultMessage: 'Scheduled task turned on successfully',
        id: 'ee4AUg',
    },
    tasksResumedSuccessfully: {
        defaultMessage: 'Scheduled task(s) turned on successfully',
        id: 'f6xT1Y',
    },
    taskRanSuccessfully: {
        defaultMessage: 'Scheduled task ran successfully',
        id: 'K7tsik',
    },
    tasksRanSuccessfully: {
        defaultMessage: 'Scheduled task(s) ran successfully',
        id: 'l8IRTD',
    },
    ...
    pauseTaskTitle: { defaultMessage: 'Turn off scheduled task', id: 'YMjUWP' },
    pauseTasksTitle: { defaultMessage: 'Turn off scheduled task(s)', id: 'tkr5bn' },
    resumeTaskTitle: { defaultMessage: 'Turn on scheduled task', id: '73c47a' },
    resumeTasksTitle: { defaultMessage: 'Turn on scheduled task(s)', id: 'KiANnA' },
    runTaskTitle: { defaultMessage: 'Run scheduled task', id: 'dzy0ND' },
    runTasksTitle: { defaultMessage: 'Run scheduled task(s)', id: 'w4Nqlr' },
    deleteTaskTitle: { defaultMessage: 'Delete scheduled task', id: 'IYLPrk' },
    deleteTasksTitle: { defaultMessage: 'Delete scheduled task(s)', id: 'dhmpfi' },
    createTaskTitle: { defaultMessage: 'Create scheduled task', id: 'dJqE3e' },
    updateTaskTitle: { defaultMessage: 'Update scheduled task', id: 'w5FDGY' },
    pauseTaskInProgress: { defaultMessage: 'Turning off scheduled task {name}', id: 'N7cqYp' },
    pauseTasksInProgress: { defaultMessage: 'Turning off scheduled task(s)', id: '+ZdOJt' },
    resumeTaskInProgress: { defaultMessage: 'Turning on scheduled task {name}', id: 'Y3qQB0' },
    resumeTasksInProgress: { defaultMessage: 'Turning on scheduled task(s)', id: 'PxsPJt' },
    runTaskInProgress: { defaultMessage: 'Running scheduled task {name}', id: 'Q9IHxV' },
    runTasksInProgress: { defaultMessage: 'Running scheduled task(s)', id: 'M0ay1D' },
    deleteTaskInProgress: { defaultMessage: 'Deleting scheduled task {name}', id: 'FSZ5F/' },
    deleteTasksInProgress: { defaultMessage: 'Deleting scheduled task(s)', id: 'ZMa6Rh' },
    createTaskInProgress: { defaultMessage: 'Creating scheduled task', id: 'daUwAL' },
    updateTaskInProgress: { defaultMessage: 'Updating scheduled task', id: '53qjcm' },
    failedToLoadTasks: { defaultMessage: 'Failed to load scheduled tasks: {errorMessage}', id: 'grgDhd' },
    failedToPauseTask: { defaultMessage: 'Failed to turn off task: {errorMessage}', id: 'b3sNCU' },
    failedToResumeTask: { defaultMessage: 'Failed to turn on task: {errorMessage}', id: 'vV67Wm' },
    failedToRunTask: { defaultMessage: 'Failed to run task: {errorMessage}', id: 'jX6uvW' },
    failedToDeleteTask: { defaultMessage: 'Failed to delete task: {errorMessage}', id: 'Ad7J7h' },
    failedToCreateTask: { defaultMessage: 'Failed to create scheduled task: {errorMessage}', id: 'ZA4OiK' },
    failedToUpdateTask: { defaultMessage: 'Failed to update task: {errorMessage}', id: 'vSW3OF' },
    ...
    deleteTaskConfirmationTitle: { defaultMessage: 'Delete scheduled task', id: 'IYLPrk' },
    deleteTaskConfirmationMessage: {
        defaultMessage: 'Are you sure you want to delete task {name}? This action cannot be undone.',
        id: '0MhOuN',
    },
    deleteTasksConfirmationTitle: { defaultMessage: 'Delete scheduled task(s)', id: 'dhmpfi' },
    deleteTasksConfirmationMessage: {
        defaultMessage: 'Are you sure you want to delete the selected scheduled task(s)? This action cannot be undone.',
        id: 'l+e8nZ',
    },
    notAvailable: { defaultMessage: 'N/A', id: 'PW+sL4' },
...
export const ConnectorsResources = defineMessages({
    ...
    namePlaceholder: { defaultMessage: 'Enter connector name', id: '+2NFJn' },
    urlPlaceholder: { defaultMessage: 'Enter connection string or endpoint', id: 'f+cHle' },
    repositoryUrl: { defaultMessage: 'Repository URL', id: 'AA/tRJ' },

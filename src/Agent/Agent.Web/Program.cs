...

{
    ...
    builder.Services
        ...
        .AddSingleton<IMetaAgentCosmosDbPlugin, CosmosDbPlugin>()
        .AddSingleton<IMetaAgentAzureSqlDbPlugin, AzureSqlServerPlugin>()
        .AddSingleton<IMetaAgentEventHubPlugin, EventHubPlugin>()
        .AddSingleton<IMetaAgentServiceBusPlugin, ServiceBusPlugin>()

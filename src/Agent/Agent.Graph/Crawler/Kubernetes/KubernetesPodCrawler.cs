...
public class KubernetesPodCrawler : IResourceCrawler
{
    ...
    public async IAsyncEnumerable<GraphNode> Crawl(GraphNode node)
    {
        ...
        if (!string.IsNullOrEmpty(nodeName))
        {
            ...
            var nodeNode = new KubernetesResourceNode(null, podNode.ClusterResourceId, podNode.SubscriptionId, podNode.ResourceGroupName, podNode.Location, nodeName, Constants.KubernetesCoreGroup, Constants.KubernetesV1Version, Constants.KubernetesNodeType);

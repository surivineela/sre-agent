            ...
            var ignoredKqlFiles = new List<string>
                {
                    ...
                    "CheckAllocationFailuresDueToCapacity.kql",
                    "CheckAllocationFailuresDuringImpact.kql",
                    "CheckControllerRoleUpgrades.kql",
                    "CheckDataRoleUpgrades.kql",
                    "CheckFpsUpgrades.kql",
                    "CheckIfSiteIsThrottledDueToSubCoreThrottling.kql",
                    "CheckIfSiteIsUnderPenalty.kql",
                    "CheckIfWorkerAssignmentIsThrottledForTheSite.kql",
                    "CheckPoolConfigVersion.kql",
                    "CheckSpecializationFailuresDuringImpact.kql",
                    "CheckWorkerNotAssignedForHttpTriggers.kql",
                    "GetActivityIdOfFailedAllocationRequest.kql",
                    "GetActivityIdOfFailedSpecialization.kql",
                    "GetActivityIdsOfFailedHttpRequests.kql",
                    "GetFailedHttpRequests.kql",
                    "GetFailureDetailsForActivityId.kql",
                    "GetFunctionHostLogs.kql",
                    "GetHttpStatusCodesForImpactDuration.kql",
                    "GetScaleControllerLogs.kql",
                    "TraceActivityIdThroughFunctionsPlatformLogs.kql",

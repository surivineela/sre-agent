...
public interface IContainerAppRevisionPlugin
{
    ...
    Task<string> GetHpaHeartbeatMetrics(string region, DateTime fromDate, DateTime toDate, string revisionName, string containerAppName, string resourceGroupName, string subscriptionId, string managedClusterName, SamplingOptions? samplingOptions = null);
    ...
    Task<string> GetArmOperations(string region, DateTime fromDate, DateTime toDate, string containerAppName, string resourceGroupName, string subscriptionId, SamplingOptions? samplingOptions = null);
    ...
    Task<string> GetHttpScalerEventsForContainerApp(string region, DateTime fromDate, DateTime toDate, string containerAppName, string resourceGroupName, string subscriptionId, string managedClusterName, SamplingOptions? samplingOptions = null);

    Task<string> GetKedaOperatorEventsForContainerApp(string region, DateTime fromDate, DateTime toDate, string managedClusterName, string containerAppName, SamplingOptions? samplingOptions = null);

...
namespace FirstPartyAgent.Plugins
{
    public class KustoDashboardPlugin : IKustoDashboardPlugin
    {
        ...
        public string GenerateDashboardLink(string dashboardId, string startTime, string endTime, string region, string subscriptionId, string resourceGroupName, string containerAppName, string revisionName)
        {
            ...
            var dashboardLink = $"https://dataexplorer.azure.com/dashboards/{dashboardId}?{startTimeParam}&{endTimeParam}&{clusterUriParam}&{subscriptionIdParam}&{resourceGroupNameParam}&{containerAppNameParam}&{revisionNameParam}";

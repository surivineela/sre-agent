...
namespace FirstPartyAgent.Core.Plugins.Definitions
{
    ...
    public class ContainerAppCorednsPluginDefinition(IContainerAppCorednsPlugin Plugin)
    {
        ...
        {
            return _plugin.GetCustomDNSServers(
    ...
    ")]
        ...
        public Task<string> GetCorednsPodFailureEvents(
            ...
            string managedClusterName)
        {
            return _plugin.GetPodFailureEvents(
                region.NormalizeLocation(),
                fromDate,
                toDate,
                managedClusterName,
        ...
        public Task<string> GetSwiftBootstrapAgentPodHealthStatus(
            ...
            string managedClusterName)
        {
            return _plugin.GetPodHealthStatus(
                region.NormalizeLocation(),
                fromDate,
                toDate,
                managedClusterName,
        ...
        public Task<string> GetDNSConfigUpdateStatus(
            ...
            string managedClusterName)
        {
            return _plugin.GetDNSConfigUpdateStatus(
                region.NormalizeLocation(),
                fromDate,
                toDate,
                managedClusterName);
        ...
        public Task<string> CheckIfDNSServerFailedToResolveDot(
            ...
            string managedClusterName)
        {
            return _plugin.CheckIfDNSServerFailedToResolveDot(
                region.NormalizeLocation(),
                fromDate,
                toDate,
                managedClusterName,

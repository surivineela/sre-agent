...
namespace FirstPartyAgent.Core.FirstPartySubAgents.ACA.RevisionAgent
{
    public sealed class ContainerAppRevisionAgentFactory
    {
        ...
        DurableTaskClient durableTaskClient)
        {
            ...
            toolSignatures.Add(_toolsRegistry.GetSignature(() => managedClusterPluginDefinition.GetASIPageForManagedClusterForApp));
            ...
            toolSignatures.Add(_toolsRegistry.GetSignature(() => remediationPluginDefinition.GetKedaOperatorEventsForContainerApp));

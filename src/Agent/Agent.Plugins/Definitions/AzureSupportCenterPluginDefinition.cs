...
public class AzureSupportCenterPluginDefinition
{
    ...
    public Task<List<SupportProductFromArmModel>> GetSupportProductsFromArm(
        [Description("The resource ID of the azure resource to execute diagnostics against.")] string resourceId)
    {
        return _supportCenterPlugin.GetSupportProductsFromArm(resourceId);
    }
    ...
    {
        return _supportCenterPlugin.GetSupportProblemClassificationsForProduct(productId);
    }
    ...
    public Task<string> GetAzureSupportCenterDiagnosticResultsForQuestion(
        [Description("The resource ID of the azure resource to execute diagnostics against.")] string resourceId,
    ...
    {
        return _supportCenterPlugin.GetAzureSupportCenterDiagnosticResultsForQuestion(resourceId, targetSupportProduct, targetSupportProblemClassification, question);
    }
}

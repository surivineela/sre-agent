...
{
    private readonly ISourceCodeAnalysisPlugin sourceCodeAnalysisPlugin;

    public SourceCodeErrorAnalysisAgentPluginDefinition(ISourceCodeAnalysisPlugin sourceCodeAnalysisPlugin)
    {
        this.sourceCodeAnalysisPlugin = sourceCodeAnalysisPlugin;
    }
    ...
    public async Task<string> CorrelateErrorsWithSourceCode(
        ...
        string errorQuery)
    {
        return await sourceCodeAnalysisPlugin.QueryRepositoryBasedOnError(resourceId, errorQuery);
    }
}

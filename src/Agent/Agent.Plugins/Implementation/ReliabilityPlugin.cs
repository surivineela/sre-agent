...
public class ReliabilityPlugin : IReliabilityPlugin
{
    ...
    public async Task<string> UpdateAlwaysOn(string resourceId, bool enabled)
    {
        try
        {
            ...
            var success = await _armHelper.UpdateAlwaysOn(resourceId, enabled);
        ...
        {
            _logger.LogInternalError(ex, $"UpdateAlwaysOn failed: {ex}");
            throw;
        }
    }
    ...
    public async Task<string> UpdateHealthCheck(string resourceId, string healthCheckPath)
    {
        ...
        {
            _logger.LogInternalError(ex, $"UpdateHealthCheck failed: {ex}");
            throw;
        }
    }
    ...
    public async Task<string> UpdateAutoHeal(string resourceId, bool autoHealEnabled, AutoHealRules autoHealRules)
    {
        try
        {
            ...
            var success = await _armHelper.UpdateAutoHeal(resourceId, autoHealEnabled, autoHealRules);
        ...
        {
            _logger.LogInternalError(ex, $"UpdateAutoHeal failed: {ex}");
            throw;
        }
    }
    ...
    public async Task<string> UpdateHostWorkers(string resourceId, int numberOfWorkers)
    {
        try
        {
            ...
            var success = await _armHelper.UpdateNumberOfWorkersAppService(resourceId, numberOfWorkers);
        ...
        {
            _logger.LogInternalError(ex, $"UpdateHostWorkers failed: {ex}");
            throw;
        }
    }
    ...
    public async Task<string> GetReliabilityStatusForSubscriptions(CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var userQuery = $"Format these apps into a table with the columns App Name, Number of Workers, Auto Heal Enabled, Always On Enabled, Health Check Enabled. ** Only return the table. ** \r\n {JsonConvert.SerializeObject(ReliabilityTables)}";
        ...
        {
            _logger.LogInternalError(ex, $"GetReliabilityStatusForSubscriptions failed: {ex}");
            throw;
        }
    }
    ...
    public async Task<string> GetAppsToMonitor(CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogInternalError(ex, $"GetAppsToMonitor failed: {ex}");
            throw;
        }
    }

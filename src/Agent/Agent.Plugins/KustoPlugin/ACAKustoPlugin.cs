...
namespace Agent.Plugins.Kusto
{
    ...
    public partial class ACAKustoPlugin : IACAKustoPlugin
    {
        private readonly ILogger<ACAKustoPlugin> _logger;
        ...
        public ACAKustoPlugin(ILogger<ACAKustoPlugin> logger, KustoRegionalGroupClientProvider kustoRegionalGroupClientProvider, KustoClient kustoClient, ITeamsClient teamsClient)
        {

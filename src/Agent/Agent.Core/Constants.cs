...
public class Constants
{
    ...
    public const string AgentSpaceOboTokenScope = "https://management.azure.com/.default";
    ...
    public const string LogAnalyticsOboTokenScope = "https://api.loganalytics.io/.default";

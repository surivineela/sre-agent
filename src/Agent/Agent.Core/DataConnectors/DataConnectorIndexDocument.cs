...
#pragma warning disable IDE1006 // Naming Styles - The index created by the control plane uses lower-casing. This property and its serialized JSON form must be lower-cased to match the index.

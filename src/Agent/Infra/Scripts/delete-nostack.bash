...
az appconfig delete --name $NAME_PREFIX-appconfig --yes
echo "Purging app config..."
az appconfig purge --name $NAME_PREFIX-appconfig --yes

# Delete the rest of the resources
echo "Deleting resource group (graph db takes a while)..."
az group delete --name $NAME_PREFIX-operations-agent-3p-rg --yes

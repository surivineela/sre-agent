...
import { ResourceTypeNameResources } from '../../Strings/Resources';
...
export type PolicyEffectDetails = {
    policyEffect: string;
};

export type ExpressionEvaluationDetails = {
    expression: string;
...
export type IfNotExistsEvaluationDetails = {
    resourceId: string;
    totalResources: number;
};

export type CheckRestrictionEvaluationDetails = {
...
export enum FieldRestrictionResult {
    Required = 'Required',
    Deny = 'Deny',
    Audit = 'Audit',
    Removed = 'Removed',
...
export enum ResourceTypes {
    functionApp = 'microsoft.web/functionapp', //note: only used for display purposes
...
export const ResourceTypeToDisplayNameMap: Record<string, MessageDescriptor> = {
    [ResourceTypes.WebsiteOrFunctionApp]: ResourceTypeNameResources.website,
    [ResourceTypes.functionApp]: ResourceTypeNameResources.functionApp,
    [ResourceTypes.StorageAccounts]: ResourceTypeNameResources.storageAccounts,
    [ResourceTypes.StorageBlobContainers]: ResourceTypeNameResources.storageBlobContainers,
    [ResourceTypes.CosmosDbAccounts]: ResourceTypeNameResources.cosmosDbAccounts,
    [ResourceTypes.SqlServers]: ResourceTypeNameResources.sqlServers,
    [ResourceTypes.SqlDatabases]: ResourceTypeNameResources.sqlDatabases,
    [ResourceTypes.SqlManagedInstances]: ResourceTypeNameResources.sqlManagedInstances,
    [ResourceTypes.AksClusters]: ResourceTypeNameResources.aksClusters,
    [ResourceTypes.ContainerApps]: ResourceTypeNameResources.containerApps,
    [ResourceTypes.RedisCache]: ResourceTypeNameResources.redisCache,
    [ResourceTypes.VirtualMachines]: ResourceTypeNameResources.virtualMachines,
    [ResourceTypes.PostgreSqlFlexibleServers]: ResourceTypeNameResources.postgreSqlFlexibleServers,
    [ResourceTypes.PostgreSqlServers]: ResourceTypeNameResources.postgreSqlServers,
    [ResourceTypes.DataFactories]: ResourceTypeNameResources.dataFactories,
    [ResourceTypes.MachineLearningWorkspaces]: ResourceTypeNameResources.machineLearningWorkspaces,
    [ResourceTypes.CognitiveServices]: ResourceTypeNameResources.cognitiveServices,
    [ResourceTypes.SearchServices]: ResourceTypeNameResources.searchServices,
    [ResourceTypes.DigitalTwins]: ResourceTypeNameResources.digitalTwins,
    [ResourceTypes.IotHubs]: ResourceTypeNameResources.iotHubs,
    [ResourceTypes.ApiManagement]: ResourceTypeNameResources.apiManagement,
    [ResourceTypes.AppConfiguration]: ResourceTypeNameResources.appConfiguration,
    [ResourceTypes.ServiceBus]: ResourceTypeNameResources.serviceBus,
    [ResourceTypes.LogicApps]: ResourceTypeNameResources.logicApps,
    [ResourceTypes.ApplicationInsights]: ResourceTypeNameResources.applicationInsights,
    [ResourceTypes.LogAnalyticsWorkspaces]: ResourceTypeNameResources.logAnalyticsWorkspaces,
    [ResourceTypes.Insights]: ResourceTypeNameResources.insights,
    [ResourceTypes.Workbooks]: ResourceTypeNameResources.workbooks,
    [ResourceTypes.SapVirtualInstances]: ResourceTypeNameResources.sapVirtualInstances,
    [ResourceTypes.CostManagement]: ResourceTypeNameResources.costManagement,
};

export function getRoleIdsForResourceGroup(resourceTypes: string[], permissionsLevel: AgentAccessLevel): string[] {
    const roleIds: string[] = [];
    roleIds.push(...CoreRBACRoleIds);

    const permissionMap =
        permissionsLevel === AgentAccessLevel.high ? ResourceTypeToContributorRBACRoleNameMap : ResourceTypeToReaderRBACRoleNameMap;
...
export function getRoleNamesForResourceGroup(resourceTypes: string[], permissionsLevel: AgentAccessLevel): string[] {
    const roleIds: string[] = [];

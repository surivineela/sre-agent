...
Examples:
  # Sync all workspace memory (repo instructions + synthesized knowledge)
  srectl workspace sync

  # Sync including session insights for all threads
  srectl workspace sync --include-session-insights

  # Sync session insights for a specific thread
  srectl workspace sync --include-session-insights --thread-id abc123

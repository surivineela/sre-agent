...
if ($IsProd) {
    ...
    $tag = "1.0.224-$gitCommit" # This version prefix is enforced by https://github.com/serverless-paas-balam/sreagent-infra/blob/main/.github/workflows/build-deploy.yml#L71

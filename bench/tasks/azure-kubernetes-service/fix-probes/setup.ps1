...
Write-Host "Waiting for pod to start and begin failing health checks..."
kubectl wait --for=condition=Available=False --timeout=30s deployment/webapp -n health-check
